...
public class ReqPullMessages implements org.apache.thrift.TBase<ReqPullMessages, ReqPullMessages._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqPullMessages");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqPullMessagesStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqPullMessagesTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqPullMessages.class, metaDataMap);
  }

  public ReqPullMessages() {
  }
   ...
   */
  public ReqPullMessages(ReqPullMessages other) {
    __isset_bitfield = other.__isset_bitfield;
    this.startMessageID = other.startMessageID;
    this.stopMessageID = other.stopMessageID;
  }

  public ReqPullMessages deepCopy() {
    return new ReqPullMessages(this);
  }
  ...
  public ReqPullMessages setStartMessageID(long startMessageID) {
    this.startMessageID = startMessageID;
    setStartMessageIDIsSet(true);
    return this;
  }
  ...
  public ReqPullMessages setStopMessageID(long stopMessageID) {
    this.stopMessageID = stopMessageID;
    setStopMessageIDIsSet(true);
    return this;
  }
  ...
  public void unsetStopMessageID() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __STOPMESSAGEID_ISSET_ID);
  }
  ...
  public boolean isSetStopMessageID() {
    return EncodingUtils.testBit(__isset_bitfield, __STOPMESSAGEID_ISSET_ID);
  }

  public void setStopMessageIDIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __STOPMESSAGEID_ISSET_ID, value);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqPullMessages)
      return this.equals((ReqPullMessages)that);
    return false;
  }

  public boolean equals(ReqPullMessages that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ReqPullMessages other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ReqPullMessages typedOther = (ReqPullMessages)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqPullMessages(");
    boolean first = true;
  ...
  private static class ReqPullMessagesStandardSchemeFactory implements SchemeFactory {
    public ReqPullMessagesStandardScheme getScheme() {
      return new ReqPullMessagesStandardScheme();
    }
  }

  private static class ReqPullMessagesStandardScheme extends StandardScheme<ReqPullMessages> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqPullMessages struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqPullMessages struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ReqPullMessagesTupleSchemeFactory implements SchemeFactory {
    public ReqPullMessagesTupleScheme getScheme() {
      return new ReqPullMessagesTupleScheme();
    }
  }

  private static class ReqPullMessagesTupleScheme extends TupleScheme<ReqPullMessages> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqPullMessages struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqPullMessages struct) throws org.apache.thrift.TException {
